var EnvatoWizard = (function($){
    ...
    function window_loaded(){
        $('.envato-setup-content').unblock({ fadeOut: 0 });
        $('.envato-setup-pages').removeClass('installing').find('input').prop('disabled', false);
        ...
        function process_current(){
            if(current_item){
                ...
                jQuery.post(envato_setup_params.ajaxurl, {
                    ...
                    slug: current_item,
                    plugins: $('form[id="th-plugins-installed"] input[name="th_stratus_plugins"]').val()

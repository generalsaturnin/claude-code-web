            ...
            class dtbwp_Envato_Theme_Setup_Wizard extends Envato_Theme_Setup_Wizard {
                ...
                public function init_globals() {
                    ...
                    $this->site_styles = array(
                        ...
                        'style6' => 'Bellevue - Hotel Classic',
                        'style7' => 'Yaletown - One Pager',
                        'style8' => 'Ashbury - Apartments',
                        'style9' => 'Hostel',
                        'style10' => 'Hotel',
                        'style11' => 'Tiny Home',
                        'style12' => 'Chalet 2',
                        'style13' => 'Beach House 2',
                        'style14' => 'Countryside 2',
                        'style15' => 'Camping & RV'
                    );
                    ...
                    if ( empty( $locations ) ) {
                        ...
                        if ( $menu && ! empty( $menu->term_id ) ) {
                            set_theme_mod(
                                'nav_menu_locations',
                                array(
                                    'primary_navigation' => (int) $menu->term_id,
                                )
                            );
                        }
                    }
                ...
                public function envato_setup_readyX() {
                    ...
                    <div class="envato-setup-next-steps">
                        ...
                        <div class="envato-setup-next-steps-last">
                            ...
                            <ul>
                                <li class="documentation"><a href="http://help.bellevuetheme.com/"
